    ...
    <>
      ...
      {currentView === 'settings' ? (
        ...
        <AppChatArea
          ...
          codexContextManagement={model.codexContextManagement}
          codexContextManagementSaving={model.codexContextManagementSaving}
          onCodexContextManagementChange={model.handleCodexContextManagementChange}
          codexContextWindow={model.codexContextWindow}
          codexContextWindowTokens={model.codexContextWindowTokens}
          codexContextWindowLoading={model.codexContextWindowLoading}
          codexContextWindowSaving={model.codexContextWindowSaving}
          onCodexContextWindowChange={model.handleCodexContextWindowChange}
          onCodexContextWindowRefresh={model.refreshCodexContextWindow}
