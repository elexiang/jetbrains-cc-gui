...
export const SPECIAL_PROVIDER_IDS = {
  ...
  /** ChatGPT Chat virtual Codex provider */
  CHATGPT_CHAT: '__chatgpt_chat__',
} as const;
...
export interface CodexProviderConfig {
  ...
  isActive?: boolean;
  /** Provider is generated by the runtime and is not editable/persisted. */
  isVirtualProvider?: boolean;
  /** Marks the ChatGPT Chat Codex login provider. */
  isChatGPTChatProvider?: boolean;
  /** Optional runtime provider kind for virtual providers. */
  providerType?: string;
